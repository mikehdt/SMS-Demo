...
enum SCENES
{
    ...
    EYE_A,       // Big spooky eye slides in time with prev scene; its iris fades out, sphere from next scene fades in place
    ...
    LADY_B,      // Distant and then closeup of the lady
    EYE_B,       // Cut back to lady, who looks more worried
