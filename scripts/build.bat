...
:: Link
echo *** SDCC linking ***
sdcc -o demo.ihx -mz80 --no-std-crt0 --data-loc 0xC000 -Wl-b_BANK2=0x8000 smslib/crt0_sms.rel bank2.rel main.rel   core.rel palettes.rel scenes.rel   sintab.rel   default.rel fire.rel grid.rel particles.rel plasma.rel sphere.rel sineline.rel type.rel   SMSlib.lib %DEBUG%
