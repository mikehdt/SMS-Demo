...
sdcc %DEBUG% --sdcccall 0 -c -mz80 ../src/picture.c -DPAL_MACHINE
echo SDCC building complete

:: Link
echo SDCC linking source
sdcc -o demo.ihx %DEBUG% --sdcccall 0 -mz80 --no-std-crt0 --data-loc 0xC000 -Wl-b_BANK2=0x8000 ../libs/crt0/crt0_sms.rel main.rel picture.rel bank2.rel ../libs/SMSlib.lib
