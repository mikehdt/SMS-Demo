...
sdcc %DEBUG% --sdcccall 0 -c -mz80 ../src/examples/sphere.c -DPAL_MACHINE
sdcc %DEBUG% --sdcccall 0 -c -mz80 ../src/examples/scroller.c -DPAL_MACHINE
sdcc %DEBUG% --sdcccall 0 -c -mz80 ../src/examples/grid.c -DPAL_MACHINE
echo SDCC building complete

:: Link
echo SDCC linking source
sdcc -o demo.ihx %DEBUG% --sdcccall 0 -mz80 --no-std-crt0 --data-loc 0xC000 -Wl-b_BANK2=0x8000 ../src/libs/crt0_sms.rel ../src/libs/SMSlib.lib main.rel sphere.rel bank2.rel
